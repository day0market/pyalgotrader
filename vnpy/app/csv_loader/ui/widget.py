...
class CsvLoaderWidget(QtWidgets.QWidget):
    ...
    def init_ui(self):
        """"""
        self.setWindowTitle("CSV loading ")
        ...
        file_button = QtWidgets.QPushButton(" select a document ")
        file_button.clicked.connect(self.select_file)

        load_button = QtWidgets.QPushButton(" loading data ")
        ...
        form.addRow(" cycle ", self.interval_combo)
        form.addRow(QtWidgets.QLabel())
        form.addRow(head_label)
        form.addRow(" timestamp ", self.datetime_edit)
        form.addRow(" opening price ", self.open_edit)
        form.addRow(" highest price ", self.high_edit)
        form.addRow(" lowest ", self.low_edit)
        form.addRow(" closing price ", self.close_edit)
