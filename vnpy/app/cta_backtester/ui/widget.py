...
class BacktesterManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        ...
        self.order_dialog = BacktestingResultDialog(
            self.main_engine,
            self.event_engine,
            " backtesting commissioned record ",
            BacktestingOrderMonitor
        )
        self.daily_dialog = BacktestingResultDialog(
            self.main_engine,
            self.event_engine,
            " back-tested daily profit and loss ",
            DailyResultMonitor
        )
...
class DailyResultMonitor(BaseMonitor):
    ...
    headers = {
        ...
        "trade_count": {"display": " transaction amount ", "cell": BaseCell, "update": False},
        "start_pos": {"display": " opening positions ", "cell": BaseCell, "update": False},
        "end_pos": {"display": " closing positions ", "cell": BaseCell, "update": False},
        "turnover": {"display": " turnover ", "cell": BaseCell, "update": False},
        "commission": {"display": " fees ", "cell": BaseCell, "update": False},
        "slippage": {"display": " slippage ", "cell": BaseCell, "update": False},
        "trading_pnl": {"display": " trading profit and loss ", "cell": BaseCell, "update": False},
        "holding_pnl": {"display": " profit and loss positions ", "cell": BaseCell, "update": False},
        "total_pnl": {"display": " total profit and loss ", "cell": BaseCell, "update": False},
        "net_pnl": {"display": " net profit and loss ", "cell": BaseCell, "update": False},
    }
...
class CandleChartDialog(QtWidgets.QDialog):
    ...
    def init_ui(self):
        """"""
        self.setWindowTitle(" backtesting K line chart ")
