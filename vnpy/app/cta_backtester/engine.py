...
class BacktesterEngine(BaseEngine):
    ...
    def start_backtesting(
        ...
        if self.thread:
            self.write_log(" task has been in operation ， please wait for completion ")
            return False
    ...
    def run_optimization(
        ...
        if use_ga:
            ...
            self.write_log(" start multi-parameter optimization process ")
        ...
        # Clear thread object handler.
        self.thread = None
        self.write_log(" multi-parameter optimization process is completed ")
