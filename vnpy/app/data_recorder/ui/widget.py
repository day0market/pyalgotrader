...
class RecorderManager(QtWidgets.QWidget):
    ...
    def init_ui(self):
        """"""
        self.setWindowTitle(" quotes record ")
        ...
        add_bar_button = QtWidgets.QPushButton(" add to ")
        add_bar_button.clicked.connect(self.add_bar_recording)

        remove_bar_button = QtWidgets.QPushButton(" remove ")
        remove_bar_button.clicked.connect(self.remove_bar_recording)

        add_tick_button = QtWidgets.QPushButton(" add to ")
        add_tick_button.clicked.connect(self.add_tick_recording)

        remove_tick_button = QtWidgets.QPushButton(" remove ")
        ...
        grid.addWidget(QtWidgets.QLabel("Tick recording "), 1, 0)
        grid.addWidget(add_tick_button, 1, 1)
        grid.addWidget(remove_tick_button, 1, 2)

        hbox = QtWidgets.QHBoxLayout()
        hbox.addWidget(QtWidgets.QLabel(" native code "))
        ...
        grid2.addWidget(QtWidgets.QLabel("K line list of records "), 0, 0)
