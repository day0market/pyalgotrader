...
class RecorderEngine(BaseEngine):
    ...
    def add_bar_recording(self, vt_symbol: str):
        ...
        if vt_symbol in self.bar_recordings:
            self.write_log(f" already at K line list of records ：{vt_symbol}")
            return
        ...
        self.write_log(f" add to K line recording success ：{vt_symbol}")
    ...
    def remove_bar_recording(self, vt_symbol: str):
        ...
        if vt_symbol not in self.bar_recordings:
            self.write_log(f" out K line list of records ：{vt_symbol}")
            return
        ...
        self.write_log(f" remove K line recording success ：{vt_symbol}")
