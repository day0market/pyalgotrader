...
class OesGateway(BaseGateway):
    ...
    def _connect_td_sync(self, config_path, username, password):
        ...
        if self.td_api.connect():
            self.write_log(_(" successfully connected to the transaction server "))
            ...
            self.write_log(_(" unable to connect to the trading server ， please check your configuration "))
    ...
    def _connect_md_sync(self, config_path, username, password):
        ...
        if self.md_api.connect():
            self.write_log(_(" successfully connect to the server market "))
            self.md_api.start()
        else:
            self.write_log(_(" unable to connect to the server market ， please check your configuration "))
