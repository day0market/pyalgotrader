...
class OnetokenGateway(BaseGateway):
    ...
    def connect(self, setting: dict):
        ...
        exchange = setting[" exchange "].lower()
...
class OnetokenRestApi(RestClient):
    ...
    def on_query_time(self, data, request):
        ...
        msg = f" server time ：{server_time}， the machine time ：{local_time}"
...
class OnetokenDataWebsocketApi(WebsocketClient):
    ...
    def on_disconnected(self):
        """"""
        self.gateway.write_log(" price Websocket API disconnect ")
    ...
    def on_login(self, data: dict):
        """"""
        self.gateway.write_log(" price Websocket API login successful ")
...
class OnetokenTradeWebsocketApi(WebsocketClient):
    ...
    def on_disconnected(self):
        """"""
        self.gateway.write_log(" transaction Websocket API disconnect ")
    ...
    def on_subscribe_info(self, data: str):
        """"""
        if data == "success":
            self.gateway.write_log(" successful push subscription account funds ")

    def on_subscribe_order(self, data: str):
        """"""
        if data == "success":
            self.gateway.write_log(" commissioned update push subscription success ")
