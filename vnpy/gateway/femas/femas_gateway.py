...
class FemasGateway(BaseGateway):
    ...
    def if_error_write_error(self, msg: str, error: dict):
        """
         when there is an error on the output error ， and return True
        """
...
class FemasMdApi(MdApi):
    ...
    def onRspUserLogin(self, data: dict, error: dict, reqid: int, last: bool):
        ...
        """
        if self.gateway.if_error_write_error(" login failed server market ", error):
            return
    ...
    def onRspError(self, error: dict, reqid: int, last: bool):
        ...
        """
        self.gateway.if_error_write_error(" quotes interface error ", error)

    def onRspSubMarketData(self, data: dict, error: dict, reqid: int, last: bool):
        """"""
        if self.gateway.if_error_write_error(" subscribe to market failure ", error):
            return
...
class FemasTdApi(TdApi):
    ...
    def onRspUserLogin(self, data: dict, error: dict, reqid: int, last: bool):
        ...
        if not error["ErrorID"]:
            ...
            self.gateway.if_error_write_error(" login failed transaction server ", error)

    def onRspOrderInsert(self, data: dict, error: dict, reqid: int, last: bool):
        """"""
        if self.gateway.if_error_write_error(" trading commission failed ", error):
            return
    ...
    def onRspOrderAction(self, data: dict, error: dict, reqid: int, last: bool):
        """"""
        if self.gateway.if_error_write_error(" trading withdrawals failure ", error):
            return
    ...
    def onRtnOrder(self, data: dict):
        ...
        """
        #  update maximum number declaration 
        self.localid = max(self.localid, int(
            data["UserOrderLocalID"]))  #  check and increase the number of local declaration 
